...
def upgrade():
    ...
    op.execute(
        'UPDATE "Artist" SET seeking_description = False WHERE seeking_description IS NULL')
    op.execute(
    ...
    op.execute(
        'UPDATE "Venue" SET seeking_description = False WHERE seeking_description IS NULL')
    op.execute(
        'UPDATE "Venue" SET seeking_talent = False WHERE seeking_talent IS NULL')
